...
import { FaHome, FaBuffer, FaInfoCircle, FaSearchengin,FaBlogger,FaGripLines } from "react-icons/fa"
...
class App extends React.Component
{
  render ()
  {
    ...
    return (
     ...
     <div>
       {/* <nav classNameName=' relative bg-gray-900 h-16 flex justify-between px-10 md:36 items-center'>
        <div>
          <a href="#"><img src={logo} classNameName="h-10"/></a>
        </div>
        <button classNameName='hover:scale-90'>
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" 
          xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" 
          d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" 
          clip-rule="evenodd"
          classNameName='text-white md:hidden'>
          </path>
        </svg>
        </button>
        <div id="navlinks" classNameName='
        text-white hidden flex-col md:flex 
        absolute top-16 p-6 left-0 bg-slate-500 w-full
        justify-between items-center space-x-4 mr-10' >
          <a href="#" classNameName='hover:text-orange-300 
              flex justify-center items-center 
              hover:scale-95 transition ease-in-out'> 
          <FaHome classNameName='mr-2'/>Home</a>
          <a href="#" classNameName='hover:text-orange-300 
              flex justify-center items-center 
              hover:scale-95 transition ease-in-out'> 
          <FaBuffer classNameName='mr-2'/>Projects</a>
          <a href="#" classNameName='hover:text-orange-300 
              flex justify-center items-center 
              hover:scale-95 transition ease-in-out'> 
          <FaInfoCircle classNameName='mr-2'/>About Me</a>
          <a href="#" classNameName='hover:text-orange-300 
              flex justify-center items-center 
              hover:scale-95 transition ease-in-out'> 
          <FaSearchengin classNameName='mr-2'/>Skills</a>
          <a href="#" classNameName='hover:text-orange-300 
              flex justify-center items-center 
              hover:scale-95 transition ease-in-out'>
          <FaBlogger classNameName='mr-2'/>Blog</a>
        </div>
       </nav> */}
